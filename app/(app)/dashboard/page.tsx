...
// ICON 3D SVG
// ═══════════════════════════════════════════════════════
function Icon3D({ iconKey, size=20, color="currentColor", fillContainer=false }) {
  const s = size;
  const id = `i${iconKey}${s}x`.replace(/[^a-zA-Z0-9]/g,"");
  const w = fillContainer ? "100%" : s;
  const h = fillContainer ? "100%" : s;
  const svgStyle = fillContainer
    ? { color, display:"block", flexShrink:0, width:"100%", height:"100%" }
    : { color };

  if (iconKey === "home") return (
    <svg width={w} height={h} viewBox="0 0 24 24" fill="none" style={svgStyle}>
  ...
  if (iconKey === "fire") return (
    <svg width={w} height={h} viewBox="0 0 48 48" fill="none" style={svgStyle}>
  ...
  if (iconKey === "star") return (
    <svg width={w} height={h} viewBox="0 0 32 32" fill="none" style={svgStyle}>
  ...
  return <svg width={w} height={h} viewBox="0 0 24 24" fill="none" style={svgStyle}><circle cx="12" cy="12" r="8" stroke="currentColor" strokeWidth="1.5" strokeOpacity="0.4"/></svg>;
}
        ...
        {[
          ...
          >
            <div style={{
              ...
              <Icon3D iconKey={s.iconKey} size={56} fillContainer />
            </div>
